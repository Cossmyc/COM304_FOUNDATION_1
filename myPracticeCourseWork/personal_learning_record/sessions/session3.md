...
* Further overview for a computer architecture (Raspberry Pi)
* Using of said Raspberry Pi to create a working traffic light system with the help of Node-RED programming tool and WiringPi open-source code for easy control of the GPIO
...
WiringPi GPIO pinout - https://pinout.xyz/pinout/uart
